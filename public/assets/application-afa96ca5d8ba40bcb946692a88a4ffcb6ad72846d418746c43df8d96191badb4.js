...
var Browser = React.createClass({
  ...
  render: function () {
    var collection = this.state.industries.map((function (industry) {
      return React.createElement(Industry, { name: industry.name,
        uri: industry.uri,
        slug: industry.slug,
...
var Industry = React.createClass({
  ...
  render: function () {
    ...
    var collection = this.state.categories.map((function (category) {
